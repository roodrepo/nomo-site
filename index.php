...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" type="text/css" href="css/nomo.css">
                ...
                <div class="col-lg-3 col-md-4 col-8 p-0">
                    <div class="navbar-header">
                        <a class="navbar-brand page-scroll" href="index.php">
                            <img alt="nomo" src="images/logo.png">
                        </a>
                    </div>
                </div>
                    ...
                    <div class="row m-0">
                        <div class="col-lg-6 p-0 fadeInLeft">
                            <div class="banner-detail-inner">
                                <h1 class="banner-title"><span>Decentralized</span></br>arbitrage maker</h1>
                                <p>Allocate funds to take part of the price re-balancing between centralized & decentralized exchanges.</p>
                                <a href="#contact-part" class="btn big-width btn-color">Get started</a>
                            </div>
                        </div>
                        <div class="col-lg-6 p-0">
                            <div class="banner-main-img">
                                <div class="front-bg fadeInRight">
                                    <img src="images/banner-img.svg" alt="Nomo">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                    ...
                    <div class="aboutus-detail pb-md-30">
                        <div class="aboutus-detail-inner">
                            <div class="heading-part mb-20 mb-sm-30 mb-xs-20">
                                <h2 class="main_title">With Nomo</h2>
                                <span>There is no missing out</span>
                            </div>
                            <p>Provide liquidity to a risk free investment hedge and create consistent revenues in your desired currencies.</p>
                            <ul>
                                <li>Keep full custody of your asset</li>
                                <li>Supply fully correlated to the profits generated</li>
                                <li>Fast & secured</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 order-lg-1 order-md-2">
                    <div class="about-img text-right text-md-center fadeInLeft">
                        <img src="images/about-img.svg" alt="Nomo">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="services-box mb-30">
                            <div class="frontend">
                                <div class="services-icon services1">
                                    <img src="images/services-icon1.svg" alt="Nomo">
                                </div>
                                <div class="services-detail">
                                    <h3 class="ser-title">Custody</h3>
                                    <div class="ser-subtitle">Non-custodial arbitrage market protocol where users can participate as depositors</div>
                                </div>
                            </div>
                            <div class="backend">
                                <div class="services-detail">
                                    <div class="ser-subtitle">Depositors provide liquidity to the market to earn a passive income</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="services-box mb-30">
                            <div class="frontend">
                                <div class="services-icon services2">
                                    <img src="images/services-icon2.svg" alt="nomo">
                                </div>
                                <div class="services-detail">
                                    <h3 class="ser-title">Integration</h3>
                                    <div class="ser-subtitle">Taking advantage of a wide range of exchanges</div>
                                </div>
                            </div>
                            <div class="backend">
                                <div class="services-detail">
                                    <div class="ser-subtitle">Raydium, Project Serum, Binance, Bithumb, Gate.io and more</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="services-box mb-30">
                            <div class="frontend">
                                <div class="services-icon services3">
                                    <img src="images/services-icon4.svg" alt="nomo">
                                </div>
                                <div class="services-detail">
                                    <h3 class="ser-title">Reliable & Low Cost</h3>
                                    <div class="ser-subtitle">Based on Solana, we use the fastest technology</div>
                                </div>
                            </div>
                            <div class="backend">
                                <div class="services-detail">
...
<!--                            <div class="frontend">-->
<!--                                <div class="services-icon services1">-->
<!--                                    <img src="images/services-icon5.svg" alt="nomo">-->
<!--                                </div>-->
<!--                                <div class="services-detail">-->
...
<!--                            <div class="frontend">-->
<!--                                <div class="services-icon services2">-->
<!--                                    <img src="images/services-icon6.svg" alt="nomo">-->
<!--                                </div>-->
<!--                                <div class="services-detail">-->
                ...
                <div class="col-lg-6 fadeInLeft">
                    <div class="tokensale-detail pb-md-30">
                        <div class="tokensale-detail-inner">
                            <div class="heading-part mb-20 mb-sm-30 mb-xs-20">
                                <h2 class="main_title">Token Distribution</h2>
                ...
                <div class="col-lg-6 align-right center-md">
                    <div class="token-graph">
                        ...
                        <div class="graph-logo">
                            <img src="images/graph-logo.png" alt="nomo">
                        </div>
                    </div>
                </div>
            </div>
...
<!--                                <img src="images/member1.jpg" alt="nomo">-->
<!--                            </div>-->
...
<!--                        <div class="team-box mb-30">-->
<!--                            <div class="team-thumb">-->
<!--                                <img src="images/member2.jpg" alt="nomo">-->
<!--                            </div>-->
<!--                            <div class="team-detail">-->
<!--                                <h3 class="member-name">John Doe</h3>-->
...
<!--                        <div class="team-box mb-30">-->
<!--                            <div class="team-thumb">-->
<!--                                <img src="images/member3.jpg" alt="nomo">-->
<!--                            </div>-->
<!--                            <div class="team-detail">-->
<!--                                <h3 class="member-name">John Doe</h3>-->
...
<!--                        <div class="team-box mb-30">-->
<!--                            <div class="team-thumb">-->
<!--                                <img src="images/member4.jpg" alt="nomo">-->
<!--                            </div>-->
<!--                            <div class="team-detail">-->
<!--                                <h3 class="member-name">John Doe</h3>-->
...
<!--                                                        How nomo different from other ICO-->
<!--                                                    </a>-->
<!--                                                </h3>-->
                        ...
                        <ul>
                            <li>
                                <div class="contact-thumb">
                                    <img src="images/mail-icon.svg" alt="Nomo">
                                </div>
                            ...
                            <li>
                                <div class="contact-thumb">
                                    <img src="images/address-icon.svg" alt="Nomo">
                                </div>
                                <div class="contact-box-detail">
                                    <h3 class="contact-title">Visit Office</h3>
                                    <p>Duddell Street - Hong Kong</p>
                                </div>
                            </li>
                        </ul>
                    </div>
